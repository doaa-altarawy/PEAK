...
if __name__ == "__main__":
    ...
    datasetName = 'Net3_conn_final'
    # datasetName = 'Root'    #'Net1', 'Net3_conn_final', 'Net4', 'Grene'
    # datasetName = 'Grene'
    # priorFile = '../data/Roots_li/processed/PK_file.csv'
    priorFile = None
    ...
    params = OrderedDict([('fileName', ''), ('priorPercent', 100), ('falsePriorRatio', 0),
                          ('priorWeight', 0.01), ('priorFile', priorFile), ('pkEachGene', 1),
                          ('alpha', 0.1), ('l1_ratio', 0.5), ('isCV', 1), ('fit_intercept', 1),
                          ('scaleX', 1), ('halfLife', 10), ('method', 'PenaltyScaling'), ('freeCV', 0)])
    ...
    AUROC, AUPR, fpr, tpr = get_accuracy_realData(network=datasetName, predFile=pathToPred, visualize=False)
    print('fpr', fpr)
    print('tpr', tpr)
